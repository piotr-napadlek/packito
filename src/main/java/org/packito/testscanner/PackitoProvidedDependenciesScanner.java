...
import org.packito.annotations.DependencyProvider;
import org.packito.annotations.MockProvider;
import org.packito.annotations.MockedDependency;
import org.packito.annotations.ProvidedDependency;
...
public class PackitoProvidedDependenciesScanner implements ProvidedDependenciesScanner {

    @Override
    public DependenciesContainer getProvidedDependencies(Object testClassInstance) throws PackitoInitializationException {
    ...
    private Map<Class<?>, Object> findClassesToMock(Object testClassInstance, List<Field> testedClassFields,
                                                     Function<Class<?>, ?> mockProvider) throws PackitoInitializationException {
        ...
        for (Field field : annotatedFields) {
            try {
                ...
                e.printStackTrace();
                throw new PackitoInitializationException("Field with the name " + field.getName() + " could not be accessed.");
            } finally {
    ...
    private Map<Class<?>, Object> findProvidedDependencies(Object testClassInstance, List<Field> testedClassFields) throws PackitoInitializationException {
        ...
        for (Field field : annotatedFields) {
            try {
                ...
                throw new PackitoInitializationException("Field with the name " + field.getName() + " marked as @ProvidedDependency was null "
    ...
    private Map<Class<?>, Supplier<?>> findDependencyProviders(Object testClassInstance, List<Field> testedClassFields) throws PackitoInitializationException {
        ...
        for (Field field : annotatedFields) {
            try {
                ...
                throw new PackitoInitializationException("Field with the name " + field.getName() + " is of incorrect type." +
                                                                 " Proper type for a @DependencyProvider is Supplier<?>");
            } catch (NullPointerException npe) {
                throw new PackitoInitializationException("Field with the name " + field.getName() + " marked as @DependencyProvider was null "
                                                                 + "(and it's not allowed to be null)");
            } finally {
                field.setAccessible(false);
            }
    ...
    private Function<Class<?>, Object> findMockProvider(Object testClassInstance, List<Field> testedClassFields) throws PackitoInitializationException {
        ...
        if (mockProviderField != null) {
            try {
                ...
                throw new PackitoInitializationException("Could not access field marked as @MockProvider");
            } catch (ClassCastException e) {
                throw new PackitoInitializationException("Field marked as @MockProvider is not of correct type."
